({
getProgramList : function(cmp,helper) {
         var action = cmp.get("c.getProgramRec");
    ...
    action.setParams({
          ...
          var records =response.getReturnValue();
                ...
                records.forEach(function(record){
                    ...
                    console.log('Location Name '+record.Lightning_Step__Locations__r.Name);
                    record.locationName = record.Lightning_Step__Locations__r.Name;
